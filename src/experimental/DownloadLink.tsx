...
const DownloadLink: Component<{document?: object, fileName: string, displayText?: string, class?: string, handleClick?: JSX.EventHandlerUnion<HTMLAnchorElement, MouseEvent>}> = (props) => {
