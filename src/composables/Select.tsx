...
const Select: Component<{handleEvent?: JSX.EventHandlerUnion<HTMLSelectElement, InputEvent>, label: string, description?: string, name: string, options: Array<{label: string, value: string, disabled?: boolean, selected?: boolean}>, firstIsDefault?: boolean, disabled?: boolean, optional?: boolean}>  = (props) => {
    return (
        <div class="field-container">
            ...
            <div class="select-area">
                <select required={!props.optional} oninput={props.handleEvent} name={props.name} id={props.name} disabled={props.disabled}>
